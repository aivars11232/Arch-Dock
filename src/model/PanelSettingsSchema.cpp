...
const QVector<Descriptor> &schemaFields()
{
    static const QVector<Descriptor> result{
        ...
        panel("presentationMode", Access::Internal, Type::String,
              Normalization::LowerString, QString{}, "presentation.mode", {}, {}, {}, true),
        panel("collapseAxis", Access::Internal, Type::String,
              Normalization::LowerString, QString{}, "presentation.collapseAxis", {}, {}, {},
              true),
        panel("collapseMechanism", Access::Internal, Type::String,
              Normalization::LowerString, QString{}, "presentation.collapseMechanism", {}, {},
              {}, true),
        panel("revealHandle", Access::Internal, Type::String,
              Normalization::LowerString, QString{}, "presentation.revealHandle", {}, {}, {},
              true),
        ...
        panel("iconStyle", Access::Editor, Type::String, Normalization::TrimmedString,
              QString{}, "iconStyle.styleReference", {}, {}, {}, true, true),
        panel("iconThemeId", Access::Editor, Type::String,
              Normalization::TrimmedString, QString{}, "iconStyle.themeId", {}, {}, {}, true,
              true),
        ...
        exposedTo(panel("iconAnimation", Access::Editor, Type::String,
              ...
              {"none", "bounce", "elastic", "pulse", "scale", "spin", "idle-rotate",
               ...
               "float", "wave", "ripple", "magnetic", "spring"}, false, true,
        ...
        exposedTo(panel("animationTrigger", Access::Editor, Type::String,
              ...
              {"hover", "click", "launch", "running", "drop", "reveal", "idle"}, false,
              true,
